...
describe('AutocompleteComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ AutocompleteComponent, RootComponent ],
  ...
  it('check input dialog true', () => {
    const autocomplete = fixtureRoot.debugElement.queryAll(By.directive(CdkOverlayOrigin))[1].componentInstance as AutocompleteComponent;
    expect(autocomplete.dialog).toBeTrue();
  });

  it('check input dialog false', () => {
    const autocomplete = fixtureRoot.debugElement.queryAll(By.directive(CdkOverlayOrigin))[0].componentInstance as AutocompleteComponent;
